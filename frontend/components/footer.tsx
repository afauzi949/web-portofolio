      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
              ...
              <div className="w-full flex-1 bg-white border-4 border-black rounded-3xl py-4 px-4 md:py-6 md:px-8 flex flex-col md:flex-row items-center gap-4 md:gap-6">
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-xl md:text-2xl font-bold text-black">Let's connect!</h3>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg md:text-xl font-bold">Achmad Al Fauzi</span>
              </div>
              <p className="text-gray-400 mb-6 text-sm leading-relaxed">
                Cybersecurity enthusiast and Internet Technology Engineering student focused on building secure digital
                infrastructures.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>
                  <span className="hover:text-white transition-colors">Cybersecurity</span>
                </li>
                <li>
                  <span className="hover:text-white transition-colors">Network Security</span>
                </li>
                <li>
                  <span className="hover:text-white transition-colors">Cloud Computing</span>
                </li>
                <li>
                  <span className="hover:text-white transition-colors">Python & Bash</span>
                </li>
                <li>
                  <span className="hover:text-white transition-colors">Docker & KVM</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  <a href="mailto:alfauzi949@gmail.com" className="hover:text-white transition-colors">
                    alfauzi949@gmail.com
                  </a>
                </li>
                <li className="flex items-center gap-2">
                  <Phone className="w-4 h-4" />
                  <a href="tel:+6283124051446" className="hover:text-white transition-colors">
                    +62 831-2405-1446
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>© 2025 Achmad Al Fauzi Dhiaulhaq - Built with Next.js & Tailwind CSS</p>
          </div>
        </div>
      </div>
    </footer>
